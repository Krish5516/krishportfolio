...
export const CardHoverReveal = () => {
  const data = [
...

    {
      ...
      description: `In Backend Development, I focus on creating robust server-side applications using technologies such as Codeigniter,ASP.net and Databases like MySQL. I design and implement APIs, manage server configurations, and ensure the security and efficiency of web applications.`,
...

    {
      ...
      description: `With a strong foundation in web programming, I develop efficient and responsive web applications. My experience includes frontend and backend development using modern web technologies, along with a solid understanding of databases, and web architecture.`,
